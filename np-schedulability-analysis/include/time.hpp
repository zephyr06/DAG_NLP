...
inline NP::Interval<dtime_t> I(const dtime_t &a, const dtime_t &b)
{
	return NP::Interval<dtime_t>{a, b};
}

// inline NP::Interval<dense_t> I(const dense_t &a, const dense_t &b)
// {
// 	return NP::Interval<dense_t>{a, b};
// }
