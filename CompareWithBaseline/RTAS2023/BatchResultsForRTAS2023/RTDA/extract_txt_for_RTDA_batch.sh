...
methods_result_dir_name=( "Initial_Res" "OrderOpt_Res" "OrderOpt_Res_LoopCount" "Verucchi_Res" "TOM_Res" "TOM_Res_LoopCount" "OrderOpt1LP_Res" "OrderOpt1LP_Res_LoopCount" )
