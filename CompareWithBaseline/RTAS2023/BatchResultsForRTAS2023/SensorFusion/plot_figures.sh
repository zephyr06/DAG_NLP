...
./extract_txt_for_SensorFusion_batch.sh
echo "Plot from results in directory: $RESULTS_PATH"

python $ROOT_PATH/CompareWithBaseline/BatchResultsForRTAS2023/$title/VisualizeSensorFusionPerformanceRTAS2023.py --minTaskNumber $MinTaskNumber \
