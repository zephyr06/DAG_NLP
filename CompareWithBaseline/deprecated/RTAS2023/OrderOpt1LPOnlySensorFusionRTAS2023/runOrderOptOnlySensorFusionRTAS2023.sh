...
title="OrderOpt1LPOnlySensorFusionRTAS2023"
MinTaskNumber=3
MaxTaskNumber=30
...
methods_result_dir_name=( "Initial_Res" "OrderOpt1LP_Res" "OrderOpt1LP_Res_LoopCount" ) # only do Initial and OrderOpt
target_method_res_name="OrderOpt1LP_Res"
...
call_the_executable() {
  ...
  ./tests/tBatchOrderOpt1LP # only test OrderOpt1LP
