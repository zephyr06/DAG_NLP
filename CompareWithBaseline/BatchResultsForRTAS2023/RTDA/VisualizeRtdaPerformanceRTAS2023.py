...
parser.add_argument('--result_file_path', type=str, default="/home/dong/workspace/DAG_NLP/CompareWithBaseline/BatchResultsForRTAS2023/RTDA",
...
methods_name = ["Initial", "OrderOpt", "Verucchi", "Initial"] # used to read result files
legends_name = ["Initial", "OrderOpt", "Verucchi20", "Initial"] # "Wang21"
marker_list = ["o", "s", "D", "v"]  #
