...
namespace OrderOptDAG_SPACE
{
  namespace OptimizeSF
  {
    ...
    public:
      ...
      static double EvaluateRTDA(const DAG_Model &dagTasks, const TaskSetInfoDerived &tasksInfo,
                                 const VectorDynamic &startTimeVector, const ScheduleOptions scheduleOptions);

      static double EvaluateSF(const DAG_Model &dagTasks, const TaskSetInfoDerived &tasksInfo,
                               const VectorDynamic &startTimeVector, const ScheduleOptions scheduleOptions);
    };
  } // namespace OptimizeSF
} // namespace OrderOptDAG_SPACE