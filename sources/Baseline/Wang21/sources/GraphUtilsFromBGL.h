...
// #include "sources/Baseline/Wang21/sources/RegularTasks.h"
#include "sources/Baseline/Wang21/sources/DeclareDAG.h"
// #include "sources/Baseline/Wang21/sources/DAG_Model.h"
...
namespace RTSS21IC_NLP
{
    ...
    vector<int> FindDependencyOrder(const OrderOptDAG_SPACE::DAG_Model &dagTasks)
    {
        ...
        {
            const RegularTaskSystem::TaskSet &tasksPrev = itr->second;
