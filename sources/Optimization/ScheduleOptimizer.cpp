...
namespace OrderOptDAG_SPACE
{
    ...
    void ScheduleOptimizer::AddCauseEffectiveChainConstraintsFromReactMap(const std::unordered_map<JobCEC, std::vector<JobCEC>> &react_chain_map)
    {
    ...
    void ScheduleOptimizer::AddWeightedObjectives()
    {
    ...
    IloExpr ScheduleOptimizer::GetStartTimeExpression(JobCEC &jobCEC)
    {
        IloExpr exp(env_);
    ...
    IloExpr ScheduleOptimizer::GetFinishTimeExpression(JobCEC &jobCEC)
    {
