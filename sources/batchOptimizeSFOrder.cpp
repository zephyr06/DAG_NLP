#include "batchOptimizeSFOrder.h"
...
namespace OrderOptDAG_SPACE
{
    ...
    std::vector<BatchResult> BatchOptimizeOrder(std::vector<OrderOptDAG_SPACE::BaselineMethods> baselineMethods, std::string dataSetFolder)
    {
        std::string dirStr = dataSetFolder;
        const char *pathDataset = (dirStr).c_str();
