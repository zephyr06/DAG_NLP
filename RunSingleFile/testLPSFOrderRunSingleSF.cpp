...
TEST(DAG_Optimize_schedule, v1) {
    ...
    sth = OrderOptDAG_SPACE::OptimizeSF::ScheduleDAGModel<
        LPOrderScheduler, OrderOptDAG_SPACE::OptimizeSF::SensorFusionObj>(
...
//     auto dagTasks = ReadDAG_Tasks(GlobalVariablesDAGOpt::PROJECT_PATH +
//     "TaskData/test_n5_v38.csv", "orig");
...
//    std::cout << "The result after optimization is " << Color::green <<
//    sth.optimizeError
